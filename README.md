...
### Бейджи Credly
[![IBM AI Engineering Professional Certificate (V2)](https://images.credly.com/size/110x110/images/5d33407f-063c-41e1-ab97-79603bd33095/Professional_Certificate_-_AI_Engineering.png)](https://www.credly.com/badges/2e76509a-6ae6-4aba-8910-5876268d4912/linked_in_profile)
...
| Название проекта                                                   | Краткое описание                                                                                                                                                                                                                                                         | Используемые библиотеки                                             |
|--------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------|
| [14 - Выпускной проект](https://github.com/DanielNRU/projects_for_courses/tree/main/Yandex_Praktikum_Data_Science_Projects/capstone_project) | Итоговый проект, включающий все этапы работы с данными: от их сбора и предобработки до построения моделей и анализа результатов. Проект может включать различные задачи, такие как классификация, регрессия, кластеризация и другие.                                       | `pandas`, `numpy`, `matplotlib`                                      |
